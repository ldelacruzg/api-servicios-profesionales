...
@RestController
@RequestMapping("api/profesionales_certificaciones")
@CrossOrigin("*")
public class ProfesionalCertificacionController {
    ...
    //ACTUALIZAR
    @PutMapping(value =  "{id}")
    private ResponseEntity<ProfesionalCertificacion>update(@PathVariable Long id, @RequestBody ProfesionalCertificacion entity){
        try {
